...
if not BOT_TOKEN:
    critical_error_message = (
        "CRITICAL ERROR: The DISCORD_BOT_TOKEN environment variable is not set. "
        "This token is required for the bot to connect to Discord. "
        "Please ensure you have a .env file with DISCORD_BOT_TOKEN set, "
        "or that the environment variable is otherwise available in your deployment."
    )
